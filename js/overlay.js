...
document.addEventListener("DOMContentLoaded", () => {
  ...
  "Servir com amor é a missão da UPUP. <strong>Família que transforma</strong>"
          // 👉 pode expandir sua lista completa aqui
        ];
      ...
      // 3. Auto-fecha em 10s (dá tempo de carregar a imagem do flyer).
      //    Clique também fecha, mas só depois de 1s (evita fechar por
      //    clique/scroll acidental durante o load).
      ...
      const autoCloseId = setTimeout(closeOverlay, 10000);
